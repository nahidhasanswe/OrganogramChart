                ...
                [
                    {
                        ...
                        f: '<div class="customBox" onClick="View()"><div>' + (val.FirstName + ' ' + val.LastName) + '</div><div class="title">' + val.Title + '</div><div class="title">' + val.TitleOfCourtesy + '</div></div>'
                    },
